...
public class Stock {
	...
	public Stock(String userName, String password, String stockName, double profit, int stockQuantity, int buyerAge) {
		super();
	...
	public String toString() {
		return "Stock [userName=" + userName + ", password=" + password + ", stockName=" + stockName + ", profit="
				+ profit + ", stockQuantity=" + stockQuantity + ", buyerAge=" + buyerAge + "]";
	} 
